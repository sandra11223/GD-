            ...
            <div className="lg:col-span-5 relative mt-12 lg:mt-0 flex items-center justify-center">
              <div className="relative w-full max-w-[280px] sm:max-w-md lg:max-w-lg aspect-square p-4 sm:p-8" style={{
                ...
                <svg className="absolute inset-0 w-full h-full text-gold-400/70 pointer-events-none z-10">
                  ...
                  {/* Top to Center */}
                  <line x1="50%" y1="20%" x2="50%" y2="38%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterContact)" className="animate-pulse" style={{animationDelay: '0.2s'}}/>
                  {/* Right to Center */}
                  <line x1="80%" y1="50%" x2="62%" y2="50%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterContact)" className="animate-pulse" style={{animationDelay: '0.5s'}}/>
                  {/* Bottom to Center */}
                  <line x1="50%" y1="80%" x2="50%" y2="62%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterContact)" className="animate-pulse" style={{animationDelay: '0.8s'}}/>
                  {/* Left to Center */}
                  <line x1="20%" y1="50%" x2="38%" y2="50%" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 2" markerEnd="url(#arrowToCenterContact)" className="animate-pulse" style={{animationDelay: '1.1s'}}/>
                </svg>
